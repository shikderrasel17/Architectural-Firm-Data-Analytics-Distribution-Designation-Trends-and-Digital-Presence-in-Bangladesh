...
- The main objectives of this analysis are:
  - Identify the distribution of architectural firms across different regions of Bangladesh.
  - Examine the designation and role distribution within these firms.
  - Investigate the growth trend of firms over the last few years.
  - Compare the number of IAB Member Architects with IAB Graduates.
  - Evaluate the digital presence of these firms by analyzing their websites and rating statuses.

## Data Sources:
- **IAB Architectural Dataset**: The dataset used in this analysis is stored at `F:\Python dummy cleaning data.csv`, containing detailed information on IAB-registered firms in Bangladesh.

## Tools:
- **Excel**: Data aggregation and basic manipulation.
- **Python**: Using libraries such as Pandas, NumPy, Matplotlib, and regex for data cleaning, analysis, and visualization.
